...
begin
  ...
  AddLabel(Tab, 'Prompt', 260, 210); AgentPromptMemo := TMemo.Create(Tab); AgentPromptMemo.Parent := Tab; AgentPromptMemo.SetBounds(380, 210, 620, 300); AgentPromptMemo.ScrollBars := ssAutoBoth;
  ...
  OMOAgentPromptMemo := TMemo.Create(Tab); OMOAgentPromptMemo.Parent := Tab; OMOAgentPromptMemo.SetBounds(680, 16, 390, 180); OMOAgentPromptMemo.ScrollBars := ssAutoBoth;
  ...
  OMOCategoryPromptMemo := TMemo.Create(Tab); OMOCategoryPromptMemo.Parent := Tab; OMOCategoryPromptMemo.SetBounds(680, 330, 390, 180); OMOCategoryPromptMemo.ScrollBars := ssAutoBoth;
  ...
  Tab := AddTab('Profile');
  ProfileList := TListBox.Create(Tab); ProfileList.Parent := Tab; ProfileList.SetBounds(16, 16, 260, 590);
